...
ROSS_QUOTES = ("PIVOT!", "We were on a break!", "Unagi!")
MONICA_QUOTES = ("Seven!", "I have to clean.")
RACHEL_QUOTES = ("Sorry I'm late, but I left late. ...",)
PHOEBE_QUOTES = ("That is brand new information.", "She's your lobster. ...")
CHANDLER_QUOTES = ("Tell him to email me at www-dot-haha-not-so-much-dot-com!")
JOEY_QUOTES = ("How you doin'?", "Va' fa Napoli!", "Here come the meat sweats...")
...
print(friend.upper() + ": Hi I am " + friend.upper() + "! " + random.choice(MONICA_QUOTES))
while flag:
    user_response = input()
